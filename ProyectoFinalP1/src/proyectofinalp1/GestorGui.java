...
public class GestorGui extends javax.swing.JFrame {
    ...
    public static Tienda items = new Tienda();
    ...
    public GestorGui() {
        ...
        if (Inventario.isEmpty()) {
            Tienda item1 = new Tienda("Cereal", 30, 10);
            Tienda item2 = new Tienda("Arroz", 40, 20);
            Tienda item3 = new Tienda("Yogurt", 60, 30);
            Tienda item4 = new Tienda("Leche", 50, 15);
            Tienda item5 = new Tienda("Pan", 20, 25);
            Tienda item6 = new Tienda("Huevos", 70, 12);
            Tienda item7 = new Tienda("Queso", 80, 8);
    ...
    public ArrayList<Tienda> getInventario() {
        return Inventario;
    }

    public void setInventario(ArrayList<Tienda> Inventario) {
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(jPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, 548,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void EliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_EliminarActionPerformed
        ...
        if (idStr != null && !idStr.isEmpty()) {
            try {
                ...
                if (!seEncontro) {
                    JOptionPane.showMessageDialog(null, "No se encontró ningún item con el ID ingresado.");
                    return;
                }
                for (int i = 0; i < Inventario.size(); i++) {
                ...
                JOptionPane.showMessageDialog(null, "El ID ingresado no es un número entero válido.");
            }
        }
    ...
    private void AgregarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_AgregarActionPerformed
        ...
        Tienda nuevoItem = new Tienda(nombre, precio, cantidad);
